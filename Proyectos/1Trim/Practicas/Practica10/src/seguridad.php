...
{
    session_destroy();
    die(error_page("Practica 10","<p>No se ha podido conectar a la BD: ".$e->getMessage()."</p>"));
}
...
catch(Exception $e)
{
    ...
    session_destroy();
    die(error_page("Practica 10","<p>No se ha podido realizar la consulta: ".$e->getMessage()."</p>"));
}
