...
<form action="index.php" method="post" enctype="multipart/form-data">
    ...
    <p>
        <label>Tipo:</label><br/>
        <input type="radio" name="tipo" <?php if($tipo=="normal") echo "checked";?> value="normal" id="normal"> <label for="normal"> Normal</label><br/>
        <input type="radio" name="tipo" <?php if($tipo=="admin") echo "checked";?> value="admin" id="admin"> <label for="admin"> admin</label><br/>
    </p>
